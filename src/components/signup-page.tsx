...
//         username: user.firstname + user.lastname, // Or however you wish to handle usernames
//         email: user.email,
...
//               placeholder="Tyler"
//               type="text"
//               value={user.firstname} // Bind value
...
import React, { useState } from "react";
import axios from "axios";
import { Input } from "@/components/ui/input"; // Assumed path
import { Label } from "@/components/ui/label"; // Assumed path
...
const SignupForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setError("");
    try {
      // Replace `"/api/users/signup"` with your actual sign-up API endpoint
